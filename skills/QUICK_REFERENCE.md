...
1. **上传文件到服务器**
   ```bash
   scp skills/*.md skills/*.json server:/var/www/credit-trader.app/
   ```

2. **配置 Nginx**
   ```nginx
   location /skill.md {
     alias /var/www/credit-trader.app/skill.md;
   }
   location /heartbeat.md {
     alias /var/www/credit-trader.app/heartbeat.md;
   }
   location /rules.md {
     alias /var/www/credit-trader.app/rules.md;
   }
   location /skill.json {
     alias /var/www/credit-trader.app/skill.json;
   }
   ```

3. **验证访问**
   ```bash
   curl https://credit-trader.app/skill.md
   curl https://credit-trader.app/heartbeat.md
   curl https://credit-trader.app/rules.md
   curl https://credit-trader.app/skill.json
   ```
