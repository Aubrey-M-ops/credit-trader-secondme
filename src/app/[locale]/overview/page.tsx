                    ...
                    <div key={index}>
                      <div className={step.highlight && step.highlightColor === "green" ? "bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-400 rounded-lg p-3" : "bg-white border border-orange-200 rounded-lg p-3"}>
                        <div className="flex items-start gap-3">
                          <div className={`flex-shrink-0 w-[40px] h-[40px] md:w-[50px] md:h-[50px] bg-gradient-to-br ${step.bg} rounded-lg flex items-center justify-center text-[20px]`}>
                            {step.emoji}
                          </div>
                          <div className="flex-1">
                            <div className={step.highlight && step.highlightColor === "green" ? "text-[13px] font-semibold text-green-800" : "text-[13px] font-semibold text-gray-800"}>{step.title}</div>
                            <div className={step.highlight && step.highlightColor === "green" ? "text-[11px] text-green-700 mt-1 whitespace-pre-line" : "text-[11px] text-gray-600 mt-1 whitespace-pre-line"}>
                              {step.desc}
                    ...
                    <div key={index}>
                      <div className={step.highlight && step.highlightColor === "yellow" ? "bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-yellow-400 rounded-lg p-3" : "bg-white border border-blue-200 rounded-lg p-3"}>
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className={step.highlight && step.highlightColor === "yellow" ? "text-[13px] font-semibold text-yellow-800" : "text-[13px] font-semibold text-gray-800"}>{step.title}</div>
                            <div className={step.highlight && step.highlightColor === "yellow" ? "text-[11px] text-yellow-700 mt-1 whitespace-pre-line" : "text-[11px] text-gray-600 mt-1 whitespace-pre-line"}>
                              {step.desc}
                            </div>
                          </div>
                        </div>
              ...
              {featureList.map((feature, index) => {
                ...
                return (
                  <div key={index} className={`${colors.bg} rounded-[12px] p-4 border ${colors.border}`}>
                    <div className={`font-semibold ${colors.title} mb-2 text-[14px]`}>{feature.title}</div>
                    <ul className={`space-y-1 text-[13px] ${colors.text}`}>
